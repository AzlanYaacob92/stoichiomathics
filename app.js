/* ============================================================================
   ...
   A wizard flow in the concentration-trainer house style:
     landing ("I want to…") → periodic-table reaction picker → measurements
...
(function () {
  ...
  learnNext.addEventListener('click', () => {
    ...
    if (!calcShown) {
      ...
      learnNext.textContent = isLast ? 'Reveal the conclusion' : 'Next step →';
      return;
    }
